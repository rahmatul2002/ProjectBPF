               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>Selmat datang di aplikasi Sistem Informasi Penggajian Karyawan <br>Lion Parcel Rokan Hulu</p>
                     </div>
                  </div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan Lion Parcel Rokan Hulu</div>
            </div>
            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/img/logolion.png" class="rounded-circle w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name">PENGGAJIAN KARYAWAN</div>
                           <div class="Job">Lion Parcel Rokan Hulu</div>
